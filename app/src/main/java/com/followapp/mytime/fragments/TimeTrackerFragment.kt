...
class TimeTrackerFragment(private val storedState: StoredState) : Fragment(R.layout.fragment_time_tracker) {
    ...
    private lateinit var rvChronometers: RecyclerView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvChronometers = view.findViewById(R.id.rvChronometers)
        ...
        secondaryChronometers = SecondaryChronometers(allChronometers, rvChronometers, mainChronometer)

        rvChronometers.layoutManager = LinearLayoutManager(requireContext())
        rvChronometers.adapter = ChronometerAdapter(secondaryChronometers)
